...
# Регулярки для маскирования чувствительных данных в URL.
_URL_MASK_PATTERNS = [
...
# Регулярки для маскирования чувствительных полей в JSON-теле ответа.
_BODY_MASK_PATTERNS = [
...
# Заголовки, значения которых не логируем.
...
class BaseDomainException(Exception):
    ...
    def _log_error_details(self, message: str, response: httpx.Response) -> None:
        """Логирование деталей ошибки без чувствительных данных."""
